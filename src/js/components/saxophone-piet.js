export function setupSaxophonePiet(element) {
  element.innerHTML = `
    <section class="section section-dark" style="min-height: 40vh; display: flex; align-items: center; justify-content: center; position: relative; overflow: hidden; margin-bottom: 2rem;">
      ...
      <img src="/images/sint_show_stage.jpg" alt="Saxophone Piet" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; object-position: center; z-index: 0; filter: blur(5px) brightness(0.5);">
      ...
      <div class="container" style="position: relative; z-index: 2; text-align: center; padding-top: 3rem; padding-bottom: 3rem;">
        ...
        <p style="font-size: 1.3rem; color: #f0f0f0; max-width: 900px; margin: 0 auto; line-height: 1.6; text-shadow: 0 2px 10px rgba(0,0,0,0.8);">
          Gezellige live muziek voor een onvergetelijke sfeer
        </p>
      </div>
    </section>

    <section id="saxophone-piet" class="section section-light" style="padding-top: 2rem;">
      <div class="container">
        ...
        <div style="max-width: 800px; margin: 0 auto 4rem auto; text-align: center; font-size: 1.2rem; color: var(--color-text-light); line-height: 1.8;">
          <p>De Saxophone Piet brengt het Sinterklaasfeest direct tot leven met prachtige live muziek. Terwijl hij vrolijk rondloopt tussen het publiek, speelt hij de bekende Sinterklaasliedjes met een verrassend swingende twist.</p><p>Zijn aanwezigheid zorgt voor een warme, ontspannen sfeer waar jong en oud van geniet. Ideaal als muzikale omlijsting tijdens het wachten of als sfeermaker tijdens een Meet & Greet.</p>
        </div>
